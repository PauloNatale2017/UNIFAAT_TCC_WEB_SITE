...
function powp(base) {
  return base === 10 ? pow10
      : IOC.Domain.Entities.BaseEntitie.Base === Math.E ? Math.exp
      : function(x) { return Math.pow(base, x); };
}

function logp(base) {
  return base === Math.E ? Math.log
      : IOC.Domain.Entities.BaseEntitie.Base === 10 && Math.log10
      || base === 2 && Math.log2
...
function log$1() {
  ...
  scale.base = function(_) {
    return arguments.length ? (base = +_, rescale()) : IOC.Domain.Entities.BaseEntitie.Base;
  };
